...
import net.chessbuddies.engine.evaluators.EasyEvaluator;
import net.chessbuddies.engine.evaluators.Evaluator;
import net.chessbuddies.engine.evaluators.MediumEvaluator;
